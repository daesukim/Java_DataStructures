...
*/
    ...
    @Test
    @DisplayName("Additional test")
    public void additionalTest1 () {
        String s = "AAA CC DDD EEE F GG";
        LineWrap lw = new LineWrap(6);
        String s1 = lw.runGreedy(s);
        String s2 = lw.runTopdown(s);
    ...
    public void additionalTest2 () {
        String s = "This is a test. I want to get a full credit for this assignment. I hope I can get it. I want to get A on this course";
        LineWrap lw = new LineWrap(20);
        String s1 = lw.runGreedy(s);
        String s2 = lw.runTopdown(s);
        System.out.println(s1);
        System.out.println(s2);
